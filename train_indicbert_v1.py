"""
=============================================================================
TAXONOMY CLASSIFICATION BENCHMARK: IndicBERT v1 (ai4bharat/indic-bert)
=============================================================================
AI4Bharat's ALBERT-based Lightweight Indic Model (~33M parameters)
...
MODEL_DISPLAY_NAME = "IndicBERT v1 (ai4bharat/indic-bert)"
OUTPUT_DIR = "./results_indicbert_v1"
BEST_MODEL_DIR = "./best_indicbert_v1_hindi_model"
CM_OUTPUT_FILE = "indicbert_v1_confusion_matrix.png"
REPORT_OUTPUT_FILE = "indicbert_v1_classification_report.txt"
METRICS_OUTPUT_FILE = "indicbert_v1_metrics.json"
