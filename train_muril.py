"""
=============================================================================
TAXONOMY CLASSIFICATION BENCHMARK: MuRIL (google/muril-base-cased)
=============================================================================
Google's Multilingual Representations for Indian Languages (BERT-base, ~237M)
...
MODEL_DISPLAY_NAME = "MuRIL (google/muril-base-cased)"
OUTPUT_DIR = "./results_muril"
BEST_MODEL_DIR = "./best_muril_hindi_model"
CM_OUTPUT_FILE = "muril_confusion_matrix.png"
REPORT_OUTPUT_FILE = "muril_classification_report.txt"
METRICS_OUTPUT_FILE = "muril_metrics.json"
